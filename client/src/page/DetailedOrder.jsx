...
const DetailedOrder = () => {
  ...
  const [orders,setOrders]=useState(null);
    async function fetchOrders() {
        try {
            const response = await axios.get(`http://localhost:3000/order/detail/${OrderId.id}`, {
                headers: {
  ...
  return (
    <div className='flex justify-center w-full bg-[#f5f4fb] text-slate-600'>
        <div className='w-[1200px]'>
            ...
            {orders?(<div className='flex flex-row space-x-4 justify-between'>
                <NavigationOrderTab/>
                <div class='my-orders' className='flex flex-col space-y-4 w-full'>
                    <span className='text-xl mt-10 flex flex-row'>Chi tiết đơn hàng #{orders[0][0].MaDonHang} - <p className='ml-1 text-black text-xl'>{orders[0][0].TinhTrangDonHang}</p></span>
                      ...
                      <div className="basis-1/3 flex flex-col space-y-4 h-full">
                        ...
                        <div className='bg-white p-4 rounded-md h-full'>
                          <div className='flex flex-row'>
                            ...
                            <div className=''>Giao {orders[0][0].PhuongThucVanChuyen}</div>
                          </div>
                          
                          Giao vào {orders[0][0].ThoiGian} <br/>
                          Được giao bởi Nhà sách Fahasa <br/>
                          Phí vận chuyển: {orders[0][0].PhiVanChuyen}
                        </div>
                      </div>
                      <div className="basis-1/3 flex flex-col space-y-4 h-full">
                        <div>HÌNH THỨC THANH TOÁN</div>
                        <div className='bg-white p-4 rounded-md h-full'>
                        {orders[0][0].PhuongThucThanhToan}
                        </div>
                      </div>
                    </div>
                    <div class='my-orders-history' className='flex flex-col space-y-4 '>
                            <div className='order-card rounded-md flex flex-col bg-white'>
                                ...
                                {orders?(orders[1].map((product, index) => (
                                    ...
                                    <div className='flex flex-col justify-right space-y-2'>
                                        ...
                                        <div className='flex justify-end items-center'>
                                            ...
                                            <div className='text-red-400'>
                                              {`: ${orders[0][0].GiaTien+orders[0][0].PhiVanChuyen} ₫`}
                                            </div>
                                        </div> 
                                    </div>
                                </div>
