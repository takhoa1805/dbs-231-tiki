...
const SanPham = [
    {
      MaSP: 'SP000001',
      GiaTien: '210.100 ₫',
      MoTa: 'Kinh Tế Học - Khái Lược Những Tư Tưởng Lớn',
      TenSP: 'Kinh Tế Học - Khái Lược Những Tư Tưởng Lớn',
      XuatXu: null,
      SoLuongConLai: null,
      LoaiSP: null,
      MaThuongHieu: null,
      DanhSachLienQuan: null,
      SPMau: null,
      MaNguoiBan: 'Nhà sách Fahasa',
      SoSaoTrungBinh: null,
    },
    {
      MaSP: 'SP000002',
      GiaTien: '50.000 ₫',
      MoTa: 'Đơn hàng #662941585',
      TenSP: 'Tai Nghe Winlink W300 (Samsung, Oppo, Vivo, Vsmart) - Jack 3.5MM - hàng chính hãng',
      XuatXu: 'Việt Nam',
      SoLuongConLai: 4,
      LoaiSP: 'Tai nghe',
      MaThuongHieu: 'TPHT', 
      ...
      Products: [
        {
          MaSP: 'SP000001',
          SoLuong: 1,
          GiaTien: 210.100, // Example price for the product
        },
        {
          MaSP: 'SP000002',
          SoLuong: 1,
  ...
  const DonHang = [
    {
      MaDonHang: 709812581,
      PhuongThucVanChuyen: 'Giao Tiết Kiệm',
      ThoiGian: '02/03/2022',
      PhuongThucThanhToan: 'Thanh toán tiền mặt khi nhận hàng',
      TinhTrangDonHang: 'Giao hàng thành công',
      TinhTrangVanChuyen: '...',
      PhiVanChuyen: 44.0,
      DiaChi: 'Ktx khu a ( đhqg tphcm), Phường Linh Trung, Quận Thủ Đức, Hồ Chí Minh, Việt Nam',
      MaNguoiMua: '123456',
      MaCoupon: 'ABCDEF123',
      MaVoucherVanChuyen: 'Voucher123',
      GiaTien: 202.56,
    },
    {
      MaDonHang: 845567332,
      ...
      TinhTrangVanChuyen: '...',
      PhiVanChuyen: 44.0,
      DiaChi: '30 Trần Quốc Tuấn, Phường Tứ Hạ, Thị xã Hương Trà, Thừa Thiên Huế, Việt Nam',
      MaNguoiMua: '123456',
      MaCoupon: 'XYZ789',
      MaVoucherVanChuyen: 'Voucher456',
      GiaTien: 159.54,
    },
  ];
            ...
            <div className='flex flex-row space-x-4 justify-between'>
                ...
                <div class='my-orders' className='flex flex-col space-y-4 w-full'>
                    ...
                    <div class='my-orders-history' className='flex flex-col space-y-4 '>
                            <div key={donHang.id} className='order-card rounded-md flex flex-col bg-white'>
                                <div className='flex flex-row items-center space-x-4 p-4 '>         
                                    <div className='flex basis-6/12'>
                                        Sản phẩm
                                    </div>
                                    <div className="basis-2/12">Giá</div>
                                    <div className="basis-2/12">Số lượng</div>
                                    <div className="basis-2/12">Giảm giá</div>
                                ...
                                <div className='flex flex-row items-center space-x-4 border-t border-b mx-4 py-5'>         
                                      ...
                                      <div className='flex flex-col items-top h-full space-y-2'>
                                          ...
                                          <div className='flex flex-row w-full'>
                                                <div className='flex justify-end items-center text-xs'>
                                                     <button className='border p-2 rounded-md border-sky-600 text-sky-600 mr-2'>Chat với nhà bán</button>
                                                     <button className='border p-2 rounded-md border-sky-600 text-sky-600 mr-2'>Viết nhận xét</button>
                                 ...
                                 <div className='flex justify-end w-full p-4'>
                                    <div className='flex flex-col justify-right space-y-2'>
                                        ...
                                        <div className='flex justify-end items-center'>
                                            <p className='text-lg'>Khuyến mãi vận chuyển</p>
                                            {`: -30.000 ₫`}
                                        </div>
                                        <div className='flex justify-end items-center'>
                                            <p className='text-lg'>Giảm giá</p>
                                            {`: -21.540 ₫`}
                                        </div>
                                        <div className='flex justify-end items-center'>
